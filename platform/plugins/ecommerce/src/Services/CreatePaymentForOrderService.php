...
class CreatePaymentForOrderService
{
    public function execute(
        ...
        if($paymentMethod == 'cod') {
            ...
            $paymentStat = $paymentStatus == 'AUTHORIZED' ? 'completed' : 'failed';
        }
        ...
        if($paymentStat == 'completed' || $paymentMethod == 'cod') {
            ...
            // curl_setopt($ch, CURLOPT_URL, "https://myinboxmedia.in/api/mim/SendSMS?userid=MIM2300278&pwd=".$password."&mobile=974".$shipping_data->phone."&sender=Ahmedper&msg=".urlencode('"Dear '. $shipping_data->name .', Thank you for your order '. $order->code .'. Your order is being processed. Please wait for confirmation call! Your Total Bill = '. floatval($order->amount) .'AED"')."&msgtype=16");
                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                    ...
                                                                                                                    if($value->discount_percent != 0) {
                                                                                                                        if($value->is_gift == 1) {
                                                                                                                             $body .= '<tr>
                                                                                                                                ...
                                                                                                                                <td style="color:#636363;text-align:left;vertical-align:middle;padding:12px;border:1px solid #E5E5E5;">
                                                                                                                                    <div style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;text-align:left;">&#x0631;&#x002E;&#x0642; 0.00 (Free Gift)'.'</div>
                                                                                                                                </td>
                                                                                                                            </tr>';
                                                                                                                        } else {
                                                                                                                            $body .= '<tr>
                                                                                                                                ...
                                                                                                                                <td style="color:#636363;text-align:left;vertical-align:middle;padding:12px;border:1px solid #E5E5E5;">
                                                                                                                                    <div style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;text-align:left;">&#x0631;&#x002E;&#x0642;'.round((($value->price * 1) - ((($value->price * 1) / 100) * $value->discount_percent) * $value->qty), 2).'</div>
                                                                                                                                </td>
                                                                                                                            </tr>';   
                                                                                                                        }
                                                                                                                        ...
                                                                                                                        $body .= '<tr>
                                                                                                                            ...
                                                                                                                            <td style="color:#636363;text-align:left;vertical-align:middle;padding:12px;border:1px solid #E5E5E5;">
                                                                                                                                <div style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;text-align:left;">&#x0631;&#x002E;&#x0642;'.round($value->gross_amount, 2).'</div>
                                                                                                                            </td>
                                                                                                                        </tr>';
                                                                                                                      } else {
                                                                                                                        $body .= '<tr>
                                                                                                                        ...
                                                                                                                        <td style="color:#636363;text-align:left;vertical-align:middle;padding:12px;border:1px solid #E5E5E5;">
                                                                                                                            <div style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;text-align:left;">&#x0631;&#x002E;&#x0642;'.round((($value->price * 1) * $value->qty), 2).'</div>
                                                                                                                        </td>
                                                                                                                        </tr>';
                                                                                                                      }
                                                                                                                }
                                                                                                                ...
                                                                                                                $body .= '<tr>
                                                                                                                    ...
                                                                                                                    <td style="color:#636363;text-align:left;vertical-align:middle;padding:12px;border-width:4px 1px 1px 1px;border-style:solid;border-color:#E5E5E5;">
                                                                                                                        <div style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;text-align:left;">&#x0631;&#x002E;&#x0642;'.$order->sub_total.'</div>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td style="color:#636363;text-align:left;vertical-align:middle;padding:12px;border:1px solid #E5E5E5;">
                                                                                                                        <div style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;text-align:left;">
                                                                                                                            '.($order->shipping_amount == '0.00' ? 'You Got Free Shipping' : round(($order->shipping_amount * 1), 2)).'&#x0631;&#x002E;&#x0642;
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td style="color:#636363;text-align:left;vertical-align:middle;padding:12px;border:1px solid #E5E5E5;">
                                                                                                                        <div style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;text-align:left;">&#x0631;&#x002E;&#x0642;'.$order->amount.'
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td style="text-align:left;vertical-align:top;width:50%;">
                                                                                                                    ...
                                                                                                                    <address style="color:#636363;font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;padding:12px;border:1px solid #E5E5E5;">'.$billing_data->name.'<br> '.$billing_data->address.'<br>'.$billing_data->state.'<br>'.$billing_data->city.'<br>
                                                                                                                        <span style="color:#C7944B;font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;">
                                                                                                                            <u>
                                                                                                                                 <a style="color:#C7944B;" href="" title="tel:+974'.$billing_data->phone.'">+974'.$billing_data->phone.'</a>
                                                                                                                            </u>
                                                                                                                        </span><br>
                                                                                                                ...
                                                                                                                <td style="text-align:left;vertical-align:top;width:50%;">
                                                                                                                    ...
                                                                                                                    <address style="color:#636363;font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;padding:12px;border:1px solid #E5E5E5;">'.$shipping_data->name.'<br> '.$shipping_data->address.'<br>'.$shipping_data->state.'<br>'.$shipping_data->city.'<br>
                                                                                                                        <span style="color:#C7944B;font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;">
                                                                                                                            <u>
                                                                                                                                <a style="color:#C7944B;" href="" title="tel:+974'.$shipping_data->phone.'">+974'.$shipping_data->phone.'</a>
                                                                                                                            </u>
                                                                                                                        </span><br>
                                                                                                                        <span style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;">
