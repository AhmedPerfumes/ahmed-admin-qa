...
class DiscountRequest extends Request
{
    ...
    {
        // $start_date_time = "{$this->input('start_date')} {$this->input('start_time')}:00";
        // if($this->has('end_date') && ! $this->has('unlimited_time')) {
        //     $end_date_time = "{$this->input('end_date')} {$this->input('end_time')}:00";
        // }
        // dd($start_date_time);
        $this->merge([
