...
class ExternalConfiguration
{
    ...
    function __construct()
    {
        ...
        // $this->merchantID = "testrest"; //Cyber Source Test
        $this->merchantID = env('CYBER_SOURCE_MERCHANT_ID');
        // $this->apiKeyID = "08c94330-f618-42a3-b09d-e1e43be5efda"; //Cyber Source Test
        $this->apiKeyID = env('CYBER_SOURCE_API_KEY');
        // $this->secretKey = "yBJxy6LjM2TmcPGu+GaJrHtkke25fPpUX+UY6/L/1tE="; //Cyber Source Test
        $this->secretKey = env('CYBER_SOURCE_SECRET_KEY');
        ...
        $this->keyAlias = env('CYBER_SOURCE_MERCHANT_ID');
        $this->keyPass = env('CYBER_SOURCE_MERCHANT_ID');
        $this->keyFilename = env('CYBER_SOURCE_MERCHANT_ID');
        $this->keyDirectory = "../Resources/";
        $this->runEnv = env('CYBER_SOURCE_RUN_ENV');
